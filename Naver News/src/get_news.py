...
while True:
    ...
    now_page = [page for page in pages if page['aria-pressed'] == 'true'][0].text
    next_page = [page for page in pages if page.text == str(int(now_page) + 1)]
    try:
        url = 'https://search.naver.com/search.naver' + next_page[0]['href']
    except:
        break
